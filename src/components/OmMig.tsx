...
function OmMig() {
  return (
    <section id="about-me-section" className="about-me">
      <h2 id="who-am-i" className="title-main">
        Who am I?
      </h2>
      <div id="aboutme-wrapper">
        <div id="aboutme-box">
          <p id="about-me-css-text">
            <span className="classtext">.about-me</span>{" "}
            ...
            <span className="stringtext"> "Märta Ballardini"</span>
            ...
            <span className="classtext"> 20</span>
            <span className="normaltext">;</span>
            <br></br>
            <span className="normaltext">
              {"\u00A0"}
            ...
            <span className="stringtext"> "Stockholm, Sweden"</span>
            <span className="normaltext">;</span>
            <br></br>
            <span className="normaltext">
              {"\u00A0"}
            ...
            <br></br>
            <br></br>
            <span className="idtext">#education</span>{" "}
            <span className="normaltext">
              {" "}
              &#123; <br></br>
              {"\u00A0"}
            ...
            <span className="stringtext"> "Medieinstitutet"</span>
            <span className="normaltext">;</span>
            <br></br>
            <span className="normaltext">
              {"\u00A0"}
            ...
            <span className="stringtext"> "Front End Developer"</span>
            <span className="normaltext">;</span>
            <br></br>
            <span className="normaltext">
              {"\u00A0"}
            ...
            <span className="stringtext"> "May 2022"</span>
            <span className="normaltext">
              ; <br></br>
              &#125;
            </span>
            <br></br>
            <br></br>
            <span className="elementtext">cv</span>{" "}
            <span className="normaltext">
              {" "}
              &#123; <br></br>
              {"\u00A0"}
