      ...
      <div id="workwrapper">
        <div id="jobs">
          ...
          <div className="job">
            ...
            <p className="work-description job-description">
              A paid internship, where i used python for visualization of
              DNS-data. <br></br> Full time
            </p>
          ...
          <div className="job">
            ...
            <p className="work-description job-description">
              {" "}
              Worked 50% in the bar and 50% in the dishes, i also helped to go
              out with food and drinks.<br></br> Full time
            </p>
          ...
          <div className="job">
            ...
            <p className="work-description job-description">
              Opened and closed the store by my self, and worked in the
              register. <br></br> Full time
            </p>
        ...
        <div id="schools">
          ...
          <div className="school">
            <strong className="work-title school-title">
              Vocational university
            </strong>
            <em className="workplace school-company">Medieinstitutet</em>
            <p className="work-description school-description">
          ...
          <div className="school">
            ...
            <em className="workplace school-company">
              Thorén Innovation School, Stockholm
            </em>
            <p className="work-description school-description">
        ...
        <div id="skills">
          ...
          <div className="skill">
            ...
            <p className="work-description skill-description">
              I won a scholarship for the best <em>Gymnasiearbete</em> at my
              high school.
            </p>
          </div>
          <div className="skill">
            ...
            <p className="work-description skill-description">
              I have knowledge in programming languages as{" "}
              <em>HTML, CSS, JavaScript</em> and <em>Python.</em> I also know{" "}
              <em>jQuery, NodeJS, Git, React.js, Angular</em> and{" "}
              <em>Agile workflow (Scrum).</em>
            </p>
          </div>
          <div className="skill">
            <strong className="work-title skill-title">languages</strong>
            <p className="work-description skill-description">
              I speak fluent Swedish and English, and can also speak some
              Spanish.
            </p>
          </div>
        </div>
