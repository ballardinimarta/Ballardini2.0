...
function Portfolio() {
    let portfolio: IWork[] = [
        ...
        { 
            ...
            description: 'Project for fun, I wanted to test SLs open data api to make a application that finds your nearest stations and lets you see the next departures from that station, works with buses, trams, and metros. Had to make my own api to use theirs, so the backend is Node and Express and the frontend is React.',
